  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved act as @act" do
        ...
        post :create, {:act => { "name" => "invalid value" }}, valid_session
        assigns(:act).should be_a_new(Act)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested act" do
        ...
        Act.any_instance.should_receive(:update_attributes).with({ "name" => "MyString" })
        put :update, {:id => act.to_param, :act => { "name" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the act as @act" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Act.any_instance.stub(:save).and_return(false)
        put :update, {:id => act.to_param, :act => { "name" => "invalid value" }}, valid_session
        assigns(:act).should eq(act)
      end
